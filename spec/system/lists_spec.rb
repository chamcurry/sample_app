# frozen_string_litereal: ture

require 'rails_helper'

RSpec.describe List, "リストモデルに関するテスト", type: :model do
  describe '投稿のテスト' do
    ...
    describe 'トップ画面（top_path）のテスト' do
      ...
      context '表示の確認' do
        it 'トップ画面（root_path）の「ここはTopページです」が表示されているか' do
          expect(page).to have_contet 'ここはTopページです'
        end
